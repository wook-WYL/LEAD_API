...
# CNBPM Dataset
python -u run.py --method LEAD --task_name supervised --is_training 1 --root_path ./dataset/ --model_id S-CNBPM-Sup --model LEAD --data SingleDataset \
...
python -u run.py --method LEAD --task_name supervised --is_training 1 --root_path ./dataset/ --model_id S-Cognision-rsEEG-Sup --model LEAD --data SingleDataset \
...
python -u run.py --method LEAD --task_name supervised --is_training 1 --root_path ./dataset/ --model_id S-Cognision-ERP-Sup --model LEAD --data SingleDataset \
