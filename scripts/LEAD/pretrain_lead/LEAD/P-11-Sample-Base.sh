...
# Pretraining
python -u run.py --method LEAD --task_name pretrain_lead --is_training 1 --root_path ./dataset/ --model_id P-11-Sample-Base --model LEAD --data MultiDatasets \
...
--e_layers 12 --batch_size 512 --n_heads 8 --d_model 128 --d_ff 256 --contrastive_loss sample --swa \
