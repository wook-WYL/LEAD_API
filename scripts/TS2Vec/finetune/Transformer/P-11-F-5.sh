...
# Finetune
python -u run.py --method TS2Vec --checkpoints_path ./checkpoints/Transformer/pretrain_ts2vec/Transformer/P-11/ --task_name finetune --is_training 1 --root_path ./dataset/ --model_id P-11-F-5 --model Transformer --data MultiDatasets \
...
# Testing
# ADFTD
python -u run.py --method TS2Vec --task_name finetune --is_training 0 --root_path ./dataset/ --model_id P-11-F-5 --model Transformer --data MultiDatasets \
