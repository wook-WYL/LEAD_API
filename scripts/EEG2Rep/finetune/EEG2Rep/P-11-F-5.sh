...
# Finetune
python -u run.py --method EEG2Rep --checkpoints_path ./checkpoints/EEG2Rep/pretrain_eeg2rep/EEG2Rep/P-11/ --task_name finetune --is_training 1 --root_path ./dataset/ --model_id P-11-F-5 --model EEG2Rep --data MultiDatasets \
...
# Testing
# ADFTD
python -u run.py --method EEG2Rep --task_name finetune --is_training 0 --root_path ./dataset/ --model_id P-11-F-5 --model EEG2Rep --data MultiDatasets \
