...
# Finetune
python -u run.py --method BIOT --checkpoints_path ./checkpoints/BIOT/pretrain_biot/BIOT/P-11/ --task_name finetune --is_training 1 --root_path ./dataset/ --model_id P-11-F-5 --model BIOT --data MultiDatasets \
...
# Testing
# ADFTD
python -u run.py --method BIOT --task_name finetune --is_training 0 --root_path ./dataset/ --model_id P-11-F-5 --model BIOT --data MultiDatasets \
